...
public class BinarySearchTree implements SortedADT {
    ...
    public String getTraversals() {
        ...
        if (this.root != null) {
            traversalsDetails += "Pets the company provides for in Alphabetical Order  : ";
    ...
    public String getAllPets() {
        String getAllPets = new String();
        if (this.root != null) {
        getAllPets += this.getInOrder(this.root.left) + "";
    } else {
        getAllPets += "tree is empty";
    }
        return getAllPets;
    }
